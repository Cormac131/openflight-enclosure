...
| --- | --- | --- |
| Camera | [`Front-Camera.stl`](../../stls/camera/v1/Front-Camera.stl) | Camera only |
| Camera + sound detector | [`Front-Camera-Sound-Detector.stl`](../../stls/camera/v1/Front-Camera-Sound-Detector.stl) **and** [`Sound-Detector-Retainer.stl`](../../stls/camera/v1/Sound-Detector-Retainer.stl) | Camera plus microphone / sound module. Print both. |
...
**Sound detector:** seat the board in the pocket, then screw [`Sound-Detector-Retainer.stl`](../../stls/camera/v1/Sound-Detector-Retainer.stl) over it into the two extra M2 inserts.
